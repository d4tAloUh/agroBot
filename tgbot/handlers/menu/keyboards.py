...
from tgbot.handlers.sale_buying.utils import get_choose_product_interest_callback_data, \
    get_choose_product_interest_callback_data
...
def make_menu_keyboard() -> InlineKeyboardMarkup:
    buttons = [
        [InlineKeyboardButton(
            ...
            static_text.choose_sale_interest_text,
            callback_data=get_choose_product_interest_callback_data(page=1)
        )],
        [InlineKeyboardButton(
